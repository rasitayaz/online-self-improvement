<%@ Page Title="" Language="C#" MasterPageFile="~/Template.Master" AutoEventWireup="true" CodeBehind="Students.aspx.cs"
    Inherits="OnlineSelfImprovement.Students" EnableEventValidation="false" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="PagePlaceHolder" runat="server">
    <h2>Öğrenciler</h2>
    <p><asp:Button ID="ButtonInsert" runat="server" OnClick="Insert_Click" Text="Yeni öğrenci" /></p>
